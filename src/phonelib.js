...
function formatInput(val, countryCode, addSuffix, allowExtension, isAllowedKey) {
    try {
...
function getError(number, countryCode) {
    try {
        var phoneUtil = i18n.phonenumbers.PhoneNumberUtil.getInstance();
        var numberObj = phoneUtil.parseAndKeepRawInput(number, countryCode);
...
function getIso2Code(number, countryCode) {
    try {
        var phoneUtil = i18n.phonenumbers.PhoneNumberUtil.getInstance();
        var numberObj = phoneUtil.parseAndKeepRawInput(number, countryCode);
...
function getDialingCode(region) {
    var phoneUtil = i18n.phonenumbers.PhoneNumberUtil.getInstance();
...
// exports
goog.exportSymbol('PhoneLib', {});
goog.exportSymbol('PhoneLib.format', format);
goog.exportSymbol('PhoneLib.getType', getType);
goog.exportSymbol('PhoneLib.isValid', isValid);
goog.exportSymbol('PhoneLib.getError', getError);
goog.exportSymbol('PhoneLib.getExample', getExample);
goog.exportSymbol('PhoneLib.formatInput', formatInput);
goog.exportSymbol('PhoneLib.getIso2Code', getIso2Code);
goog.exportSymbol('PhoneLib.getDialingCode', getDialingCode);
goog.exportSymbol('PhoneLib.getNumberInfo', getNumberInfo);
// enums
goog.exportSymbol('PhoneLib.TYPE', numberType);
goog.exportSymbol('PhoneLib.ERROR', validationError);
goog.exportSymbol('PhoneLib.FORMAT', numberFormat);